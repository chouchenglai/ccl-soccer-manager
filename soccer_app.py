...
if main_df.empty:
    ...
    if st.button("建立"):
        ...
        # 建立資料並存檔，增加 utf-8-sig 解決 Excel 亂碼
    ...
    with tab1: # 下單投注
        ...
        st.components.v1.html("""
            ...
            <div id="clock-container"><span class="prefix">系統當前時間 :</span><span id="clock">載入中...</span></div>
            ...
            <script>
                function updateClock() {
                    const now = new Date();
                    // 這裡使用 toLocaleString 並設定為 24 小時制顯示
